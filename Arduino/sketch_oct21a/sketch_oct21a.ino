...
void setup() {
  ...
  assistent.Begin(NameBoard,CMD,HCmd,6,CMDRec,HCmdRec,1,(char*)"Redline",(char*)"freedom131313");
...
void loop() {
  assistent.Handle();
  if(Rele1&&State){
    assistent.IoTMessage(AssistentVariable(new String[1] { "light"},new String[1] {"open"},1));
  }
}
