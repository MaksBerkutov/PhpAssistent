...
@section('title', 'Добавить голосовую команду')
@section('styles')
...
@section('content')
    <div class="page-shell">
        <section class="page-head">
            <div>
                <h2 class="page-title">Новая голосовая команда</h2>
                <p class="page-subtitle">Привяжите голосовую фразу к устройству и команде.</p>
            </div>
            <a href="{{ route('voice') }}" class="btn btn-outline-primary">К помощнику</a>
        </section>
        ...
        <section class="page-card" style="max-width: 840px;">
            <form action="{{ route('voice.store') }}" method="post">
                ...
                <div class="mb-3">
                    <label for="module" class="form-label">Устройство</label>
                ...
                <div class="mb-3">
                    <label for="command" class="form-label">Команда устройства</label>
                ...
                <x-default-form-input type="text" name="text_trigger" placeholder="Например: Включи свет" text="Голосовой триггер"/>
                <x-default-form-input type="text" name="voice" placeholder="Например: Свет включен" text="Текст ответа"/>

                <div class="d-flex flex-wrap gap-2">
                    <button type="submit" class="btn btn-primary">Сохранить команду</button>
                    <a href="{{ route('voice') }}" class="btn btn-outline-primary">Отмена</a>
                </div>
            </form>
        </section>
    </div>
