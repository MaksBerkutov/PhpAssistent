   ...
   v-199.3c2.1-2,6.8-5.4,12.2-5.4h202.8c6.5,0,11.9,5.3,11.9,11.9V343.99z" />
            ...
            @foreach ($menuList as $menu)
                @if (MenuGuard($menu['guard']))
                    <x-menu-item name="{{ $menu['name'] }}" href="{{ $menu['url'] }}"
                        icon="{{ $menu['image'] }}"></x-menu-item>
                @endif
            @endforeach
    ...
    <div class="alertRotate">
        <iframe src="https://giphy.com/embed/PfY4nKis93ZHXMywps" width="270" height="480" style=""
