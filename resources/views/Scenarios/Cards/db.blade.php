<div id="db-card" class="card mb-3 d-none">
    <div class="card-body">
        <h5 class="card-title">Настройки базы данных</h5>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="db_table" class="form-label">Имя таблицы</label>
        ...
        <div class="mb-3">
            <label for="db_value_field" class="form-label">Поле для значения</label>
