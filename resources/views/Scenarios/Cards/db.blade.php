<div id="db-card" class="card mb-3 d-none">
    <div class="card-body">
        ...
        <p class="text-muted small mb-3">Параметры подключения и поля для сохранения ключа/значения.</p>

        <div class="mb-3">
            <label for="db_login" class="form-label">Логин</label>
        ...
        <div class="mb-3">
            <label for="db_table" class="form-label">Таблица</label>
        ...
        <div class="mb-3">
            <label for="db_key_field" class="form-label">Поле ключа</label>
        ...
        <div class="mb-0">
            <label for="db_value_field" class="form-label">Поле значения</label>
