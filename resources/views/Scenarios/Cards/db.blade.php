<div id="db-card" class="card mb-3 d-none">
    <div class="card-body">
        <h5 class="card-title">{{ __('ui.scenarios.database') }}</h5>
        <p class="text-muted small mb-3">{{ __('ui.scenarios.cards.db_desc') }}</p>

        <div class="mb-3">
            <label for="db_login" class="form-label">{{ __('ui.scenarios.cards.db_login') }}</label>
        ...
        <div class="mb-3">
            <label for="db_password" class="form-label">{{ __('ui.scenarios.cards.db_password') }}</label>
        ...
        <div class="mb-3">
            <label for="db_name" class="form-label">{{ __('ui.scenarios.cards.db_name') }}</label>
        ...
        <div class="mb-3">
            <label for="db_table" class="form-label">{{ __('ui.scenarios.cards.db_table') }}</label>
        ...
        <div class="mb-3">
            <label for="db_key_field" class="form-label">{{ __('ui.scenarios.cards.db_key_field') }}</label>
        ...
        <div class="mb-0">
            <label for="db_value_field" class="form-label">{{ __('ui.scenarios.cards.db_value_field') }}</label>
